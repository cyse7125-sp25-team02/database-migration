pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = "karanthakkar09/database-migration"
    }
        ...
        stage('Prepare Workspace and Determine Next Version') {
            steps {
                script {
                    ...
                    git branch: 'main', url: 'https://github.com/cyse7125-sp25-team02/database-migration', credentialsId: 'github-credentials'
